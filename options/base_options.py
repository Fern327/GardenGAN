...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default='f:/git/backup/test_pics/original',
        ...
        parser.add_argument('--checkpoints_dir', type=str,
                            default='F:/git/pytorch-CycleGAN-and-pix2pix/checkpoints', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='cycle_gan',
                            help='chooses which model to use. [cycle_gan | pix2pix | multi_pix2pix | test | colorization]')
